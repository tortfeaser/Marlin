...
#define X_DUAL_STEPPER_DRIVERS // MKD was: //
#if ENABLED(X_DUAL_STEPPER_DRIVERS)
  #define INVERT_X2_VS_X_DIR true   // Set 'true' if X motors should rotate in opposite directions
  #define X_DUAL_ENDSTOPS // MKD was: //
...
#define Z_DUAL_STEPPER_DRIVERS // MDK was: //
#if ENABLED(Z_DUAL_STEPPER_DRIVERS)
  #define Z_DUAL_ENDSTOPS // MDK was: //
...
#define DISABLE_INACTIVE_X trueS
#define DISABLE_INACTIVE_Y true
#define DISABLE_INACTIVE_Z false  // set to false if the nozzle will fall down on your printed part when print has finished.
#define DISABLE_INACTIVE_E true

#define DEFAULT_MINIMUMFEEDRATE       0.0     // minimum feedrate
#define DEFAULT_MINTRAVELFEEDRATE     300 // MDK was: 0.0
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING // MDK was: //
 ...
 */
//#define PWM_MOTOR_CURRENT { 1300, 1300, 1250 }          // MDK was: // Values in milliamps
